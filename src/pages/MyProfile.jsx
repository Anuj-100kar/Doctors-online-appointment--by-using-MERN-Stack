...
function MyProfile() {
  ...
  const [userData,setUserData]=useState({
    ...
    email:'shambharkaranuj@gmail.com',
    phone:'+1 999 999 9999',
    address:{
      line1:'sant tukdoji ward',
      line2:'nandori road, hgt'
    },
    gender:"male",
    dob:'2000-01-20'
  })
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid gridd-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit? <select className='max-w-20 bg-gray-100'  value={userData.gender} onChange={e=>setUserData(prev=>({...prev,gender:e.target.value}))} name="" id="">

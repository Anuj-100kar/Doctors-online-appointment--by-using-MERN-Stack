...
const AddDoctor = () => {
  ...
  const onSubmitHandler=async(event)=>{
      ...
      try {
        ...
        const targetUrl = backendUrl + '/api/admin/add-doctor';
        console.log("Attempting to post to URL:", targetUrl);

          console.log("Value of atoken from context:", atoken);
        console.log("Type of atoken:", typeof atoken);
        console.log("Headers object being sent:", { headers: { atoken } });
        // --- END DEBUGGING LINE ---
        
        const {data} =await axios.post(targetUrl,formData,{headers:{atoken}})

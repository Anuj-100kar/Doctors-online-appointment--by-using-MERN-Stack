...
function About() {
  return (
    <div>
      <div>
        <p className='text-center pt-10 text-gray-500 text-2xl'>ABOUT <span className='text-gray-700 font-medium'>US</span></p>
        <div className='flex flex-col md:flex-row gap-12 my-10'>
          <img className='w-full md:max-w-[360px]' src={assets.about_image} alt="" />
          <div className='flex flex-col justify-center  items-start gap-6 text-sm md:w-2/4 text-gray-600'>
